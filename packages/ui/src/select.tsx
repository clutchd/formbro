...
export function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={twx("flex cursor-pointer items-center justify-center py-1", className)}
      {...props}
    >
