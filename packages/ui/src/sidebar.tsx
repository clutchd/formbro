...
import { useIsMobile } from "@formbro/shared/use-is-mobile";
...
export function SidebarProvider({
  ...
  const persistOpenState = React.useCallback((openState: boolean) => {
    const cs = (globalThis as { cookieStore?: CookieStoreLike }).cookieStore;
    if (cs) {
      void cs.set({
      ...
      try {
        localStorage.setItem(SIDEBAR_COOKIE_NAME, openState ? "1" : "0");
      } catch {}
    }
  }, []);
...
export function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="outline"
      size="icon"
      className={twx("size-7", className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
...
export function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={twx("flex flex-col gap-2 p-2", className)}
      {...props}
    />
  );
}
...
export function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={twx("relative flex w-full min-w-0 flex-col p-2", className)}
      {...props}
    />
  );
}
...
export function SidebarGroupContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={twx("w-full text-sm", className)}
      {...props}
    />
  );
}
...
export function SidebarMenu({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      data-sidebar="menu"
      className={twx("flex w-full min-w-0 flex-col gap-1", className)}
      {...props}
    />
  );
}
...
export function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={twx("group/menu-item relative", className)}
      {...props}
    />
  );
}
...
export function SidebarMenuButton({
  ...
  return (
    <Comp
      ...
      className={twx(sidebarMenuButtonVariants({ variant, size }), className)}
      {...props}
    />
  );
}
...
export function SidebarMenuSubItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={twx("group/menu-sub-item relative", className)}
      {...props}
    />
  );
}
